...
export const dashboardRoutePermissions: readonly DashboardRoutePermission[] = [
  ...
  { href: "/dashboard/ai-visual-assets", label: "AI Visual Assets", icon: "templates", permission: "team.edit" },
  ...
  { href: "/dashboard/marketing", label: "Marketing", icon: "pages", permission: "can_edit_stores", anyPermissions: ["can_edit_stores", "orders.view", "settings.edit", "can_view_notifications"] },
  ...
  { href: "/dashboard/seo/facebook-pixel", label: "Facebook Pixel", icon: "pages", permission: "settings.edit", showInSidebar: false },
  { href: "/dashboard/seo/google-analytics", label: "Google Analytics", icon: "analytics", permission: "settings.edit", showInSidebar: false },
  { href: "/dashboard/seo/redirects", label: "SEO Redirects", icon: "pages", permission: "settings.edit", showInSidebar: false },
  { href: "/dashboard/seo/search-console", label: "Search Console", icon: "pages", permission: "settings.edit", showInSidebar: false },
  ...
  { href: "/dashboard/delivery-agents", label: "Delivery Management", icon: "shipping", permission: "manage_orders" },
  { href: "/dashboard/cod", label: "COD Center", icon: "payments", permission: "manage_orders" },
