...
import {
  buildReportDataCertificationRuntimeInput,
...
import {
  loadOperationsStorageRuntimeReadOnlySafe,
...
import {
  buildOperationsDataCertificationReadOnlySafe,
  mapOperationsDataCertificationToAdminFields
} from "@/src/lib/operations/operations-data-certification-runtime";
import {
  buildOperationsSecurityCertificationReadOnlySafe,
...
import {
  buildOperationsProductionCertificationReadOnlySafe,
  mapOperationsProductionCertificationToAdminFields
} from "@/src/lib/operations/operations-production-certification-runtime";
import {
  buildOperationsStressValidationReadOnlySafe,
...
import {
  loadSupportMonitoringEventsRuntimeReadOnlySafe,
  mapSupportMonitoringEventsRuntimeToAdminFields,
  mapSupportMonitoringRuntimeItemsToDashboardMonitoringEvents,
  mapSupportMonitoringRuntimeItemsToLegacyMonitoringEvents,
...
import {
  loadSupportEventTimelineRuntimeReadOnlySafe,
  mapSupportEventTimelineRuntimeToAdminFields,
...
import {
  loadSupportAuditRuntimeReadOnlySafe,
  mapSupportAuditRuntimeToAdminFields,
...
import {
  buildSupportDataCertificationReadOnlySafe,
  mapSupportDataCertificationToAdminFields,
  resolveSupportDataCertificationAuthorization,
  toSupportDataCertificationSnapshot
} from "@/src/lib/support/support-data-certification-runtime";
import {
  buildSupportSecurityCertificationReadOnlySafe,
  mapSupportSecurityCertificationToAdminFields,
  resolveSupportSecurityCertificationAuthorization,
...
import {
  buildSupportProductionCertificationReadOnlySafe,
  mapSupportProductionCertificationToAdminFields,
  resolveSupportProductionCertificationAuthorization,
...
import {
  buildSupportProductionHardeningReadOnlySafe,
  mapSupportProductionHardeningToAdminFields,
  resolveSupportProductionHardeningAuthorization,
...
export type AdminReportingControl = {
  ...
  registry: {
    readOnly: true;
    source: "reports_registry_runtime";
  ...
  operationsReports: {
    ...
    lastGeneratedState: string;
    lastUpdatedAt: string | null;
    latestOperationsActivity: Array<{
      activityAt: string;
      activityType: string;
      category: string;
      dataAvailability: "available" | "planned";
  ...
  reportDataCertification: {
    ...
    entries: Array<{
      ...
      certificationStatus: "blocked" | "certified" | "partial" | "planned" | "unsafe" | "unknown";
      dataSourceAvailability: "available" | "partial" | "planned" | "unavailable";
  ...
  reports: Array<{
    category:
      ...
      | "Subscription Reports"
      | "User Reports";
    certificationState: "certified" | "needs_attention" | "not_applicable" | "planned";
    dataSourceDescription: string;
    exportAvailabilityState: "export_ready" | "placeholder" | "unavailable";
    ...
    supportsSafeActions: boolean;
    visibility: "internal" | "owner" | "super_admin";
  }>;
  selectedRange: "today" | "7d" | "30d" | "month" | "year";
  sources: string[];
};
...
export type AdminOperationsStorageRuntimeItem = {
  ...
  reviewStatus: string;
  runtimeStatus: string;
  safeControls: AdminOperationsStorageSafeControl[];
  storageKey: string;
  storageName: string;
  totalObjects: number;
...
export type AdminOperationsStorageRuntimeGroup = {
  groupKey: string;
  itemCount: number;
  items: AdminOperationsStorageRuntimeItem[];
  title: string;
};
...
export type AdminOperationsDataCertificationSafeControl = {
  enabled: false;
  key: string;
  label: string;
  note: string;
...
export type AdminOperationsDataCertificationItem = {
  ...
  safeControls: AdminOperationsDataCertificationSafeControl[];
  safeSummary: string;
  secretSafetyStatus: string;
  warningModules: number;
};

export type AdminOperationsDataCertificationGroup = {
  groupKey: string;
  itemCount: number;
  items: AdminOperationsDataCertificationItem[];
  title: string;
};

export type AdminOperationsSecurityCertificationSafeControl = {
  enabled: false;
  key: string;
  label: string;
  note: string;
...
export type AdminOperationsSecurityCertificationItem = {
  actionSafetyStatus: string;
  blockedModules: number;
  certificationName: string;
  certificationScope: string;
  certifiedModules: number;
  ...
  groupKey: string;
  mutationSafetyStatus: string;
  ownershipSafetyStatus: string;
  privateDataSafetyStatus: string;
  readOnlyStatus: string;
  rlsSafetyStatus: string;
  safeControls: AdminOperationsSecurityCertificationSafeControl[];
  safeSummary: string;
  secretSafetyStatus: string;
  securityCertificationKey: string;
  superAdminOnlyStatus: string;
  warningModules: number;
};

export type AdminOperationsSecurityCertificationGroup = {
  groupKey: string;
  itemCount: number;
  items: AdminOperationsSecurityCertificationItem[];
  title: string;
};
...
export type AdminOperationsProductionCertificationSafeControl = {
  enabled: false;
  key: string;
  label: string;
  note: string;
...
export type AdminOperationsProductionCertificationItem = {
  blockedModules: number;
  certificationName: string;
  certificationScope: string;
  certifiedModules: number;
  ...
  readOnlyStatus: string;
  runtimeIntegrityStatus: string;
  safeControls: AdminOperationsProductionCertificationSafeControl[];
  safeSummary: string;
  securitySafetyStatus: string;
  warningModules: number;
};

export type AdminOperationsProductionCertificationGroup = {
  groupKey: string;
  itemCount: number;
  items: AdminOperationsProductionCertificationItem[];
  title: string;
};

export type AdminOperationsStressValidationSafeControl = {
  enabled: false;
  key: string;
  label: string;
  note: string;
...
export type AdminOperationsStressValidationItem = {
  blockedModules: number;
  certifiedSystemIsolationStatus: string;
  disabledControlsStatus: string;
  emptyStateSafetyStatus: string;
  executionSafetyStatus: string;
  groupKey: string;
  metadataConsistencyStatus: string;
  mutationSafetyStatus: string;
  refreshStabilityStatus: string;
  safeControls: AdminOperationsStressValidationSafeControl[];
  safeSummary: string;
  secretSafetyStatus: string;
...
export type AdminOperationsStressValidationGroup = {
  groupKey: string;
  itemCount: number;
  items: AdminOperationsStressValidationItem[];
  title: string;
};
...
export type AdminOperationsControl = {
  ...
  dataCertification: {
    ...
    source: "operations_data_certification_runtime";
    summary: string;
    totalCertifications: number;
    warningScopes: number;
  };
  dataCertificationGroups: AdminOperationsDataCertificationGroup[];
  dataCertificationItems: AdminOperationsDataCertificationItem[];
  dataCertificationSafeControls: AdminOperationsDataCertificationSafeControl[];
  securityCertification: {
    ...
    registrySource: "operations_registry_runtime";
    reviewRequiredScopes: number;
    source: "operations_security_certification_runtime";
    summary: string;
    totalCertifications: number;
    warningScopes: number;
  };
  ...
  productionCertification: {
    ...
    registrySource: "operations_registry_runtime";
    reviewRequiredScopes: number;
    source: "operations_production_certification_runtime";
    summary: string;
    totalCertifications: number;
    warningScopes: number;
  };
  productionCertificationGroups: AdminOperationsProductionCertificationGroup[];
  productionCertificationItems: AdminOperationsProductionCertificationItem[];
  productionCertificationSafeControls: AdminOperationsProductionCertificationSafeControl[];
  stressValidation: {
    blockedScopes: number;
    groupCount: number;
    ...
    registrySource: "operations_registry_runtime";
    reviewRequiredScopes: number;
    source: "operations_stress_validation_runtime";
    stableScopes: number;
    summary: string;
  ...
  storageRuntime: {
    ...
    readOnly: true;
    registrySource: "operations_registry_runtime";
    source: "operations_storage_runtime";
...
export type AdminSupportControl = {
  ...
  monitoringEventsRuntime: {
    ...
    readOnly: true;
    registrySource: "support_registry_runtime";
    source: "support_monitoring_events_runtime";
  ...
  monitoringEventsRuntimeGroups: Array<{
    groupKey: string;
    itemCount: number;
    items: Array<{
      createdAt: string;
  ...
  monitoringEventsRuntimeItems: Array<{
    createdAt: string;
    entityType: string;
    eventId: string;
    eventKey: string;
  ...
  eventTimelineRuntime: {
    ...
    readOnly: true;
    registrySource: "support_registry_runtime";
    source: "support_event_timeline_runtime";
  ...
  eventTimelineRuntimeGroups: Array<{
    groupKey: string;
    itemCount: number;
    items: Array<{
  ...
  eventTimelineRuntimeItems: Array<{
    actorLabel: string | null;
    createdAt: string;
    eventType: string;
    eventTypeLabel: string;
  ...
  eventTimelineSafeControls: Array<{
    enabled: false;
    key: string;
    label: string;
    note: string;
  ...
  supportAuditRuntime: {
    actionTypeCounts: Array<{ actionType: string; count: number; label: string }>;
    emptyMessage: string | null;
    groupCount: number;
    hiddenRecordCount: number;
    loadError: string | null;
  ...
  supportAuditRuntimeGroups: Array<{
    groupKey: string;
    itemCount: number;
    items: Array<{
      actionType: string;
  ...
  supportAuditRuntimeItems: Array<{
    actionType: string;
    actionTypeLabel: string;
    actorReference: string;
    actorRole: string;
  ...
  supportAuditSafeControls: Array<{
    enabled: false;
    key: string;
    label: string;
    note: string;
  ...
  supportDataCertification: {
    ...
    restrictedMessage: string | null;
    reviewRequiredScopes: number;
    source: "support_data_certification_runtime";
    summary: string;
    totalCertifications: number;
    unauthorizedMessage: string | null;
    warningScopes: number;
  };
  supportDataCertificationGroups: Array<{
    groupKey: string;
    itemCount: number;
    items: Array<{
      blockedModules: number;
      ...
      certificationScope: string;
      certifiedModules: number;
      dataIntegrityStatus: "blocked" | "certified" | "review_required" | "warning";
      executionSafetyStatus: "no_execution_certified" | "review_required";
      groupKey: string;
      mutationSafetyStatus: "read_only_certified" | "review_required";
      placeholderStatus: "certified" | "labeled_placeholders" | "review_required";
      registryKey: string;
      reviewRequiredModules: number;
      safeSummary: string;
      secretSafetyStatus: "review_required" | "safe";
      stateCoverageStatus: "covered" | "review_required";
      warningModules: number;
    }>;
    title: string;
  }>;
  supportDataCertificationItems: AdminSupportControl["supportDataCertificationGroups"][number]["items"];
  supportDataCertificationSafeControls: Array<{
    enabled: false;
    key: string;
    label: string;
    note: string;
  }>;
  visibleSupportDataCertification: AdminSupportControl["supportDataCertification"];
  supportSecurityCertification: {
    blockedScopes: number;
    certifiedScopes: number;
    emptyMessage: string | null;
    groupCount: number;
    ...
    restrictedMessage: string | null;
    reviewRequiredScopes: number;
    source: "support_security_certification_runtime";
    summary: string;
    totalCertifications: number;
    unauthorizedMessage: string | null;
    warningScopes: number;
  };
  supportSecurityCertificationGroups: Array<{
    groupKey: string;
    itemCount: number;
    items: Array<{
      actionSafetyStatus: "certified" | "review_required";
      blockedModules: number;
      certificationName: string;
      certificationScope: string;
      certifiedModules: number;
      executionSafetyStatus: "certified" | "review_required";
      groupKey: string;
      mutationSafetyStatus: "certified" | "review_required";
      privateDataSafetyStatus: "certified" | "review_required";
      readOnlyStatus: "certified" | "review_required";
      rlsSafetyStatus: "certified" | "review_required";
      safeSummary: string;
      secretSafetyStatus: "certified" | "review_required";
      securityCertificationKey: string;
      superAdminOnlyStatus: "certified" | "review_required";
      visibilitySafetyStatus: "certified" | "review_required";
      warningModules: number;
    }>;
    title: string;
  }>;
  supportSecurityCertificationItems: AdminSupportControl["supportSecurityCertificationGroups"][number]["items"];
  supportSecurityCertificationSafeControls: Array<{
    enabled: false;
    key: string;
    label: string;
    note: string;
  ...
  supportProductionCertification: {
    blockedScopes: number;
    emptyMessage: string | null;
    groupCount: number;
    loadError: string | null;
    ...
    restrictedMessage: string | null;
    reviewRequiredScopes: number;
    source: "support_production_certification_runtime";
    summary: string;
    totalCertifications: number;
    unauthorizedMessage: string | null;
    warningScopes: number;
  };
  supportProductionCertificationGroups: Array<{
    groupKey: string;
    itemCount: number;
    items: Array<{
      blockedModules: number;
      ...
      mutationSafetyStatus: "blocked" | "certified" | "review_required" | "warning";
      productionCertificationKey: string;
      productionReadinessStatus: "blocked" | "production_ready" | "review_required" | "warning";
      readOnlyStatus: "blocked" | "certified" | "review_required" | "warning";
      runtimeIntegrityStatus: "blocked" | "certified" | "review_required" | "warning";
      safeSummary: string;
      securitySafetyStatus: "blocked" | "certified" | "review_required" | "warning";
  ...
  supportProductionCertificationItems: AdminSupportControl["supportProductionCertificationGroups"][number]["items"];
  supportProductionCertificationSafeControls: Array<{
    enabled: false;
    key: string;
    label: string;
    note: string;
  ...
  supportProductionHardening: {
    blockedScopes: number;
    emptyMessage: string | null;
    groupCount: number;
    hardenedScopes: number;
    loadError: string | null;
    loadingState: "empty" | "error" | "hardened" | "restricted" | "unauthorized";
    overallStatus: "needs_attention" | "support_production_hardening_ready";
    readOnly: true;
    registrySource: "support_registry_runtime";
    restrictedMessage: string | null;
    reviewRequiredScopes: number;
    source: "support_production_hardening_runtime";
    summary: string;
    totalHardeningScopes: number;
    unauthorizedMessage: string | null;
    warningScopes: number;
  };
  supportProductionHardeningGroups: Array<{
    groupKey: string;
    itemCount: number;
    items: Array<{
      blockedModules: number;
      certifiedSystemIsolationStatus: "blocked" | "hardened" | "review_required" | "warning";
      controlSafetyStatus: "blocked" | "hardened" | "review_required" | "warning";
      emptyStateStatus: "blocked" | "hardened" | "review_required" | "warning";
      executionIsolationStatus: "blocked" | "hardened" | "review_required" | "warning";
      groupKey: string;
      hardeningKey: string;
      hardeningName: string;
      hardeningScope: string;
      mutationIsolationStatus: "blocked" | "hardened" | "review_required" | "warning";
      readOnlyHardeningStatus: "blocked" | "hardened" | "review_required" | "warning";
      safeSummary: string;
      secretMaskingStatus: "blocked" | "hardened" | "review_required" | "warning";
      warningModules: number;
    }>;
    title: string;
  }>;
  supportProductionHardeningItems: AdminSupportControl["supportProductionHardeningGroups"][number]["items"];
  supportProductionHardeningSafeControls: Array<{
    enabled: false;
    key: string;
    label: string;
    note: string;
...
export async function getAdminSEOControl(): Promise<AdminSEOControl> {
  ...
  return {
    ...
    seoSecurityCertification: {
      failedChecks: seoSecurityCertificationRuntime.failedChecks,
      generatedAt: seoSecurityCertificationRuntime.generatedAt,
      passedChecks: seoSecurityCertificationRuntime.passedChecks,
      readOnly: true as const,
      status: seoSecurityCertificationRuntime.status,
...
export async function getAdminReportingControl(
  ...
  const reportDataCertificationRuntime = await mapReportDataCertificationRuntimeToAdminFields(
    buildReportDataCertificationRuntimeInput({
      adapterStatesByReportKey,
      auditEntries: reportAuditRuntime.entries.map((entry) => ({
      ...
      reviewEntries: reportReviewRuntime.entries.map((entry) => ({
  ...
  const registryRuntime = mapReportsRegistryRuntimeToAdminFields({
    ...
    reportDataCertificationLastGenerated: reportDataCertificationRuntime.lastGeneratedState,
    reportDataCertificationNeedsAttention:
      reportDataCertificationRuntime.status === "degraded" ||
  ...
  return {
    categories,
    dateFilters,
    futureHooks: registryRuntime.futureHooks,
    overview: {
    ...
    registry: {
      readOnly: true as const,
      source: registryRuntime.registry.source,
    ...
    reportDataCertification: {
      byStatus: reportDataCertificationRuntime.byStatus,
      entries: filteredCertificationEntries,
      errorMessage: reportDataCertificationRuntime.errorMessage,
      generatedAt: reportDataCertificationRuntime.generatedAt,
      lastGeneratedState: reportDataCertificationRuntime.lastGeneratedState,
      loadingState: reportDataCertificationRuntime.loadingState,
      readOnly: true as const,
      selectedReportCertification: reportDataCertificationRuntime.selectedReportCertification,
      selectedReportKey: reportDataCertificationRuntime.selectedReportKey,
      status: reportDataCertificationRuntime.status,
      summary: reportDataCertificationRuntime.summary,
      superAdminReportsOnly: true as const,
    ...
    reports,
    selectedRange,
    sources: registryRuntime.sources
  };
}
...
export async function getAdminOperationsControl(): Promise<AdminOperationsControl> {
  ...
  const operationsStorageRuntimeLoad = mapOperationsStorageRuntimeToAdminFields(
    await loadOperationsStorageRuntimeReadOnlySafe({
      monitoringEvents,
      supabase
    })
  );
  ...
  const operationsDataCertificationLoad = mapOperationsDataCertificationToAdminFields(
    buildOperationsDataCertificationReadOnlySafe({
      aiQueueRuntime: operationsAiQueueRuntimeLoad.aiQueueRuntime,
      auditItems: operationsAuditRuntimeLoad.auditItems,
      auditRuntime: operationsAuditRuntimeLoad.auditRuntime,
  ...
  const operationsSecurityCertificationLoad = mapOperationsSecurityCertificationToAdminFields(
    buildOperationsSecurityCertificationReadOnlySafe({
      aiQueueRuntime: operationsAiQueueRuntimeLoad.aiQueueRuntime,
      auditItems: operationsAuditRuntimeLoad.auditItems,
      auditRuntime: operationsAuditRuntimeLoad.auditRuntime,
  ...
  const operationsProductionCertificationLoad = mapOperationsProductionCertificationToAdminFields(
    buildOperationsProductionCertificationReadOnlySafe({
      aiQueueRuntime: operationsAiQueueRuntimeLoad.aiQueueRuntime,
      auditRuntime: operationsAuditRuntimeLoad.auditRuntime,
      backupRuntime: operationsBackupRuntimeLoad.backupRuntime,
  ...
  const operationsStressValidationLoad = mapOperationsStressValidationToAdminFields(
    buildOperationsStressValidationReadOnlySafe({
      aiQueueRuntime: operationsAiQueueRuntimeLoad.aiQueueRuntime,
  ...
  return {
    ...
    reviewSafeControls: operationsReviewRuntimeLoad.safeControls,
    dataCertification: operationsDataCertificationLoad.dataCertification,
    dataCertificationGroups: operationsDataCertificationLoad.groups,
    dataCertificationItems: operationsDataCertificationLoad.certificationItems,
    dataCertificationSafeControls: operationsDataCertificationLoad.safeControls,
    securityCertification: operationsSecurityCertificationLoad.securityCertification,
    ...
    runtimeCertificationSafeControls: operationsRuntimeCertificationLoad.safeControls,
    productionCertification: operationsProductionCertificationLoad.productionCertification,
    productionCertificationGroups: operationsProductionCertificationLoad.groups,
    productionCertificationItems: operationsProductionCertificationLoad.productionCertificationItems,
    productionCertificationSafeControls: operationsProductionCertificationLoad.safeControls,
    stressValidation: operationsStressValidationLoad.stressValidation,
...
export async function getAdminSupportControl(options?: {
  ...
  const monitoringAuthorization = resolveSupportMonitoringEventsAuthorization({
    internalRole: access.internalRole,
    role: access.role
  });
  ...
  const eventTimelineAuthorization = resolveSupportEventTimelineAuthorization({
    internalRole: access.internalRole,
    role: access.role
  });
  ...
  const dataCertificationAuthorization = resolveSupportDataCertificationAuthorization({
    role: access.role
  });
  ...
  const monitoringEventsLoad = mapSupportMonitoringEventsRuntimeToAdminFields(
    await loadSupportMonitoringEventsRuntimeReadOnlySafe({
  ...
  const eventTimelineLoad = mapSupportEventTimelineRuntimeToAdminFields(
    await loadSupportEventTimelineRuntimeReadOnlySafe({
      authorization: eventTimelineAuthorization,
      loadError: supabase ? null : "Admin client unavailable",
      supabase
    })
  );
  ...
  const supportAuditLoad = mapSupportAuditRuntimeToAdminFields(
    await loadSupportAuditRuntimeReadOnlySafe({
  ...
  const certificationDashboardLoad = mapSupportDashboardRuntimeToAdminFields({
    loadError: ticketsRuntimeLoad.ticketsRuntime.loadError ?? (supabase ? null : "Admin client unavailable"),
    monitoringEvents: mapSupportMonitoringRuntimeItemsToDashboardMonitoringEvents(
      monitoringEventsLoad.monitoringEvents
    ),
    tickets: mapSupportTicketRuntimeItemsToDashboardTickets(ticketsRuntimeLoad.tickets)
  });
  const supportDataCertificationLoad = mapSupportDataCertificationToAdminFields(
    buildSupportDataCertificationReadOnlySafe({
      analyticsRuntime: toSupportDataCertificationSnapshot({
        loadingState: supportAnalyticsLoad.supportAnalyticsRuntime.loadingState,
        loadError: supportAnalyticsLoad.supportAnalyticsRuntime.loadError,
      ...
      auditItems: supportAuditLoad.supportAuditRuntimeItems,
      auditRuntime: toSupportDataCertificationSnapshot({
        loadingState: supportAuditLoad.supportAuditRuntime.loadingState,
        loadError: supportAuditLoad.supportAuditRuntime.loadError,
      ...
      authorization: dataCertificationAuthorization,
      dashboardRuntime: toSupportDataCertificationSnapshot({
        loadError: certificationDashboardLoad.dashboard.loadError,
        readOnly: certificationDashboardLoad.dashboard.readOnly,
        source: certificationDashboardLoad.dashboard.source,
        status: certificationDashboardLoad.dashboard.status,
        summary: certificationDashboardLoad.dashboard.summary
      }),
      errorEventsRuntime: toSupportDataCertificationSnapshot({
        loadingState: errorEventsLoad.errorEventsRuntime.loadingState,
        loadError: errorEventsLoad.errorEventsRuntime.loadError,
      ...
      eventTimelineRuntime: toSupportDataCertificationSnapshot({
        loadingState: eventTimelineLoad.eventTimelineRuntime.loadingState,
        loadError: eventTimelineLoad.eventTimelineRuntime.loadError,
      ...
      exportRuntime: toSupportDataCertificationSnapshot({
        loadingState: supportExportLoad.supportExportRuntime.loadingState,
        loadError: supportExportLoad.supportExportRuntime.loadError,
      ...
      filtersRuntime: toSupportDataCertificationSnapshot({
        loadingState: supportFiltersLoad.supportFiltersRuntime.loadingState,
      ...
      hiddenRecordCount: supportVisibilityLoad.supportVisibilityRuntime.hiddenRecordCount,
      loadError: ticketsRuntimeLoad.ticketsRuntime.loadError ?? (supabase ? null : "Admin client unavailable"),
      metricsRuntime: toSupportDataCertificationSnapshot({
        loadingState: supportVisibilityLoad.visibleSupportMetricsRuntime.loadingState,
        loadError: supportVisibilityLoad.visibleSupportMetricsRuntime.loadError,
      ...
      monitoringEventsRuntime: toSupportDataCertificationSnapshot({
        loadingState: monitoringEventsLoad.monitoringEventsRuntime.loadingState,
        loadError: monitoringEventsLoad.monitoringEventsRuntime.loadError,
      ...
      notificationsRuntime: toSupportDataCertificationSnapshot({
        loadingState: supportNotificationsLoad.supportNotificationsRuntime.loadingState,
        loadError: supportNotificationsLoad.supportNotificationsRuntime.loadError,
      ...
      registryProductionReadyCount: supportRegistry.components.filter(
        (component) => component.productionReady && component.key !== "sp-data-certification"
      ).length,
      registryRuntime: toSupportDataCertificationSnapshot({
        readOnly: supportRegistry.registry.readOnly,
        source: supportRegistry.registry.source,
        status: supportRegistry.registry.status,
        summary: supportRegistry.registry.summary
      }),
      registryTotalModuleCount: supportRegistry.components.filter(
        (component) => component.key !== "sp-data-certification"
      ).length,
      restrictedRecordCount: supportVisibilityLoad.supportVisibilityRuntime.restrictedRecordCount,
      reviewItems: supportReviewLoad.supportReviewRuntimeItems,
      reviewRuntime: toSupportDataCertificationSnapshot({
        loadingState: supportReviewLoad.supportReviewRuntime.loadingState,
        loadError: supportReviewLoad.supportReviewRuntime.loadError,
      ...
      safeActionsRuntime: toSupportDataCertificationSnapshot({
        loadError: supportSafeActionsLoad.supportSafeActionsRuntime.loadError,
      ...
      searchRuntime: toSupportDataCertificationSnapshot({
        loadingState: supportSearchLoad.supportSearchRuntime.loadingState,
        loadError: supportSearchLoad.supportSearchRuntime.loadError,
      ...
      statusRuntime: toSupportDataCertificationSnapshot({
        loadingState: supportStatusLoad.supportStatusRuntime.loadingState,
        loadError: supportStatusLoad.supportStatusRuntime.loadError,
        readOnly: supportStatusLoad.supportStatusRuntime.readOnly,
        source: supportStatusLoad.supportStatusRuntime.source,
        status: supportStatusLoad.supportStatusRuntime.status,
        summary: supportStatusLoad.supportStatusRuntime.summary
      }),
      ticketAssignmentRuntime: toSupportDataCertificationSnapshot({
        loadError: assignmentLoad.ticketAssignmentRuntime.loadError,
      ...
      ticketConversationRuntime: toSupportDataCertificationSnapshot({
        loadingState: ticketConversationLoad.ticketConversationRuntime.loadingState,
        loadError: ticketConversationLoad.ticketConversationRuntime.loadError,
      ...
      ticketDetailsRuntime: toSupportDataCertificationSnapshot({
        loadingState: ticketDetailsLoad.ticketDetailsRuntime.loadingState,
        loadError: ticketDetailsLoad.ticketDetailsRuntime.loadError,
      ...
      ticketStatusRuntime: toSupportDataCertificationSnapshot({
        loadError: ticketStatusLoad.ticketStatusRuntime.loadError,
      ...
      ticketsRuntime: toSupportDataCertificationSnapshot({
        loadError: ticketsRuntimeLoad.ticketsRuntime.loadError,
      ...
      visibilityAuthorization,
      visibilityItems: supportVisibilityLoad.supportVisibilityRuntimeItems,
      visibilityRuntime: toSupportDataCertificationSnapshot({
        loadError: supportVisibilityLoad.supportVisibilityRuntime.loadError,
  ...
  const supportSecurityCertificationLoad = mapSupportSecurityCertificationToAdminFields(
    buildSupportSecurityCertificationReadOnlySafe({
      analyticsRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportAnalyticsLoad.supportAnalyticsRuntime.readOnly,
        source: supportAnalyticsLoad.supportAnalyticsRuntime.source,
        summary: supportAnalyticsLoad.supportAnalyticsRuntime.summary
      }),
      auditItems: supportAuditLoad.supportAuditRuntimeItems,
      auditRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportAuditLoad.supportAuditRuntime.readOnly,
        source: supportAuditLoad.supportAuditRuntime.source,
        summary: supportAuditLoad.supportAuditRuntime.summary
      }),
      authorization: securityCertificationAuthorization,
      dashboardRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: certificationDashboardLoad.dashboard.readOnly,
        source: certificationDashboardLoad.dashboard.source,
        summary: certificationDashboardLoad.dashboard.summary
      }),
      ...
      errorEventsRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: errorEventsLoad.errorEventsRuntime.readOnly,
        source: errorEventsLoad.errorEventsRuntime.source,
        summary: errorEventsLoad.errorEventsRuntime.summary
      }),
      eventTimelineRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: eventTimelineLoad.eventTimelineRuntime.readOnly,
        source: eventTimelineLoad.eventTimelineRuntime.source,
        summary: eventTimelineLoad.eventTimelineRuntime.summary
      }),
      exportRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportExportLoad.supportExportRuntime.readOnly,
        source: supportExportLoad.supportExportRuntime.source,
        summary: supportExportLoad.supportExportRuntime.summary
      }),
      filtersRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportFiltersLoad.supportFiltersRuntime.readOnly,
        source: supportFiltersLoad.supportFiltersRuntime.source,
        summary: supportFiltersLoad.supportFiltersRuntime.summary
      }),
      hiddenRecordCount: supportVisibilityLoad.supportVisibilityRuntime.hiddenRecordCount,
      loadError: ticketsRuntimeLoad.ticketsRuntime.loadError ?? (supabase ? null : "Admin client unavailable"),
      metricsRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportVisibilityLoad.visibleSupportMetricsRuntime.readOnly,
        source: supportVisibilityLoad.visibleSupportMetricsRuntime.source,
        summary: supportVisibilityLoad.visibleSupportMetricsRuntime.summary
      }),
      monitoringEventsRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: monitoringEventsLoad.monitoringEventsRuntime.readOnly,
        source: monitoringEventsLoad.monitoringEventsRuntime.source,
        summary: monitoringEventsLoad.monitoringEventsRuntime.summary
      }),
      notificationsRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportNotificationsLoad.supportNotificationsRuntime.readOnly,
        source: supportNotificationsLoad.supportNotificationsRuntime.source,
        summary: supportNotificationsLoad.supportNotificationsRuntime.summary
      }),
      registryRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportRegistry.registry.readOnly,
        source: supportRegistry.registry.source,
        summary: supportRegistry.registry.summary
      }),
      restrictedRecordCount: supportVisibilityLoad.supportVisibilityRuntime.restrictedRecordCount,
      reviewItems: supportReviewLoad.supportReviewRuntimeItems,
      reviewRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportReviewLoad.supportReviewRuntime.readOnly,
        source: supportReviewLoad.supportReviewRuntime.source,
        summary: supportReviewLoad.supportReviewRuntime.summary
      }),
      ...
      safeActionsRuntime: {
        ...
        superAdminOnly: supportSafeActionsLoad.supportSafeActionsRuntime.superAdminOnly
      },
      searchRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportSearchLoad.supportSearchRuntime.readOnly,
        source: supportSearchLoad.supportSearchRuntime.source,
        summary: supportSearchLoad.supportSearchRuntime.summary
      }),
      statusItems: supportStatusLoad.supportStatusRuntimeItems,
      statusRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportStatusLoad.supportStatusRuntime.readOnly,
        source: supportStatusLoad.supportStatusRuntime.source,
        summary: supportStatusLoad.supportStatusRuntime.summary
      }),
      ticketAssignmentRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: assignmentLoad.ticketAssignmentRuntime.readOnly,
        source: assignmentLoad.ticketAssignmentRuntime.source,
        summary: assignmentLoad.ticketAssignmentRuntime.summary
      }),
      ticketConversationRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: ticketConversationLoad.ticketConversationRuntime.readOnly,
        source: ticketConversationLoad.ticketConversationRuntime.source,
        summary: ticketConversationLoad.ticketConversationRuntime.summary
      }),
      ticketDetailsRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: ticketDetailsLoad.ticketDetailsRuntime.readOnly,
        source: ticketDetailsLoad.ticketDetailsRuntime.source,
        summary: ticketDetailsLoad.ticketDetailsRuntime.summary
      }),
      ticketStatusRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: ticketStatusLoad.ticketStatusRuntime.readOnly,
        source: ticketStatusLoad.ticketStatusRuntime.source,
        summary: ticketStatusLoad.ticketStatusRuntime.summary
      }),
      ticketsRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: ticketsRuntimeLoad.ticketsRuntime.readOnly,
        source: ticketsRuntimeLoad.ticketsRuntime.source,
        summary: ticketsRuntimeLoad.ticketsRuntime.summary
      }),
      visibilityAuthorization,
      visibilityItems: supportVisibilityLoad.supportVisibilityRuntimeItems,
      visibilityRuntime: toSupportSecurityCertificationSnapshot({
        readOnly: supportVisibilityLoad.supportVisibilityRuntime.readOnly,
        source: supportVisibilityLoad.supportVisibilityRuntime.source,
        summary: supportVisibilityLoad.supportVisibilityRuntime.summary
      })
  ...
  const supportProductionCertificationLoad = mapSupportProductionCertificationToAdminFields(
    buildSupportProductionCertificationReadOnlySafe({
      analyticsRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportAnalyticsLoad.supportAnalyticsRuntime.readOnly,
        source: supportAnalyticsLoad.supportAnalyticsRuntime.source,
        summary: supportAnalyticsLoad.supportAnalyticsRuntime.summary
      }),
      auditRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportAuditLoad.supportAuditRuntime.readOnly,
        source: supportAuditLoad.supportAuditRuntime.source,
        summary: supportAuditLoad.supportAuditRuntime.summary
      }),
      authorization: productionCertificationAuthorization,
      dashboardRuntime: toSupportProductionCertificationSnapshot({
        readOnly: certificationDashboardLoad.dashboard.readOnly,
        source: certificationDashboardLoad.dashboard.source,
        summary: certificationDashboardLoad.dashboard.summary
      }),
      dataCertification: supportDataCertificationLoad.dataCertification,
      dataCertificationItems: supportDataCertificationLoad.dataCertificationItems,
      errorEventsRuntime: toSupportProductionCertificationSnapshot({
        readOnly: errorEventsLoad.errorEventsRuntime.readOnly,
        source: errorEventsLoad.errorEventsRuntime.source,
        summary: errorEventsLoad.errorEventsRuntime.summary
      }),
      eventTimelineRuntime: toSupportProductionCertificationSnapshot({
        readOnly: eventTimelineLoad.eventTimelineRuntime.readOnly,
        source: eventTimelineLoad.eventTimelineRuntime.source,
        summary: eventTimelineLoad.eventTimelineRuntime.summary
      }),
      exportRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportExportLoad.supportExportRuntime.readOnly,
        source: supportExportLoad.supportExportRuntime.source,
        summary: supportExportLoad.supportExportRuntime.summary
      }),
      filtersRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportFiltersLoad.supportFiltersRuntime.readOnly,
        source: supportFiltersLoad.supportFiltersRuntime.source,
        summary: supportFiltersLoad.supportFiltersRuntime.summary
      }),
      hiddenRecordCount: supportVisibilityLoad.supportVisibilityRuntime.hiddenRecordCount,
      loadError: ticketsRuntimeLoad.ticketsRuntime.loadError ?? (supabase ? null : "Admin client unavailable"),
      metricsRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportVisibilityLoad.visibleSupportMetricsRuntime.readOnly,
        source: supportVisibilityLoad.visibleSupportMetricsRuntime.source,
        summary: supportVisibilityLoad.visibleSupportMetricsRuntime.summary
      }),
      monitoringEventsRuntime: toSupportProductionCertificationSnapshot({
        readOnly: monitoringEventsLoad.monitoringEventsRuntime.readOnly,
        source: monitoringEventsLoad.monitoringEventsRuntime.source,
        summary: monitoringEventsLoad.monitoringEventsRuntime.summary
      }),
      notificationsRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportNotificationsLoad.supportNotificationsRuntime.readOnly,
        source: supportNotificationsLoad.supportNotificationsRuntime.source,
        summary: supportNotificationsLoad.supportNotificationsRuntime.summary
      }),
      registryRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportRegistry.registry.readOnly,
        source: supportRegistry.registry.source,
        summary: supportRegistry.registry.summary
      }),
      restrictedRecordCount: supportVisibilityLoad.supportVisibilityRuntime.restrictedRecordCount,
      reviewItems: supportReviewLoad.supportReviewRuntimeItems,
      reviewRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportReviewLoad.supportReviewRuntime.readOnly,
        source: supportReviewLoad.supportReviewRuntime.source,
        summary: supportReviewLoad.supportReviewRuntime.summary
      }),
      ...
      safeActionsRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportSafeActionsLoad.supportSafeActionsRuntime.readOnly,
        source: supportSafeActionsLoad.supportSafeActionsRuntime.source,
        summary: supportSafeActionsLoad.supportSafeActionsRuntime.summary
      }),
      searchRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportSearchLoad.supportSearchRuntime.readOnly,
        source: supportSearchLoad.supportSearchRuntime.source,
        summary: supportSearchLoad.supportSearchRuntime.summary
      }),
      securityCertification: supportSecurityCertificationLoad.securityCertification,
      securityCertificationItems: supportSecurityCertificationLoad.securityCertificationItems,
      statusRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportStatusLoad.supportStatusRuntime.readOnly,
        source: supportStatusLoad.supportStatusRuntime.source,
        summary: supportStatusLoad.supportStatusRuntime.summary
      }),
      ticketAssignmentRuntime: toSupportProductionCertificationSnapshot({
        readOnly: assignmentLoad.ticketAssignmentRuntime.readOnly,
        source: assignmentLoad.ticketAssignmentRuntime.source,
        summary: assignmentLoad.ticketAssignmentRuntime.summary
      }),
      ticketConversationRuntime: toSupportProductionCertificationSnapshot({
        readOnly: ticketConversationLoad.ticketConversationRuntime.readOnly,
        source: ticketConversationLoad.ticketConversationRuntime.source,
        summary: ticketConversationLoad.ticketConversationRuntime.summary
      }),
      ticketDetailsRuntime: toSupportProductionCertificationSnapshot({
        readOnly: ticketDetailsLoad.ticketDetailsRuntime.readOnly,
        source: ticketDetailsLoad.ticketDetailsRuntime.source,
        summary: ticketDetailsLoad.ticketDetailsRuntime.summary
      }),
      ticketStatusRuntime: toSupportProductionCertificationSnapshot({
        readOnly: ticketStatusLoad.ticketStatusRuntime.readOnly,
        source: ticketStatusLoad.ticketStatusRuntime.source,
        summary: ticketStatusLoad.ticketStatusRuntime.summary
      }),
      ticketsRuntime: toSupportProductionCertificationSnapshot({
        readOnly: ticketsRuntimeLoad.ticketsRuntime.readOnly,
        source: ticketsRuntimeLoad.ticketsRuntime.source,
        summary: ticketsRuntimeLoad.ticketsRuntime.summary
      }),
      visibilityAuthorization,
      visibilityRuntime: toSupportProductionCertificationSnapshot({
        readOnly: supportVisibilityLoad.supportVisibilityRuntime.readOnly,
        source: supportVisibilityLoad.supportVisibilityRuntime.source,
        summary: supportVisibilityLoad.supportVisibilityRuntime.summary
      })
  ...
  const supportProductionHardeningLoad = mapSupportProductionHardeningToAdminFields(
    buildSupportProductionHardeningReadOnlySafe({
      analyticsRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportAnalyticsLoad.supportAnalyticsRuntime.readOnly,
        source: supportAnalyticsLoad.supportAnalyticsRuntime.source,
        summary: supportAnalyticsLoad.supportAnalyticsRuntime.summary
      }),
      analyticsSafeControls: supportAnalyticsLoad.supportAnalyticsSafeControls,
      auditRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportAuditLoad.supportAuditRuntime.readOnly,
        source: supportAuditLoad.supportAuditRuntime.source,
        summary: supportAuditLoad.supportAuditRuntime.summary
      }),
      auditSafeControls: supportAuditLoad.supportAuditSafeControls,
      authorization: productionHardeningAuthorization,
      dashboardRuntime: toSupportProductionHardeningSnapshot({
        readOnly: certificationDashboardLoad.dashboard.readOnly,
        source: certificationDashboardLoad.dashboard.source,
        summary: certificationDashboardLoad.dashboard.summary
      }),
      dataCertification: supportDataCertificationLoad.dataCertification,
      dataCertificationSafeControls: supportDataCertificationLoad.dataCertificationSafeControls,
      errorEventsRuntime: toSupportProductionHardeningSnapshot({
        readOnly: errorEventsLoad.errorEventsRuntime.readOnly,
        source: errorEventsLoad.errorEventsRuntime.source,
        summary: errorEventsLoad.errorEventsRuntime.summary
      }),
      errorEventsSafeControls: errorEventsLoad.errorEventsSafeControls,
      eventTimelineRuntime: toSupportProductionHardeningSnapshot({
        readOnly: eventTimelineLoad.eventTimelineRuntime.readOnly,
        source: eventTimelineLoad.eventTimelineRuntime.source,
        summary: eventTimelineLoad.eventTimelineRuntime.summary
      }),
      eventTimelineSafeControls: eventTimelineLoad.eventTimelineSafeControls,
      exportRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportExportLoad.supportExportRuntime.readOnly,
        source: supportExportLoad.supportExportRuntime.source,
        summary: supportExportLoad.supportExportRuntime.summary
      }),
      filtersRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportFiltersLoad.supportFiltersRuntime.readOnly,
        source: supportFiltersLoad.supportFiltersRuntime.source,
        summary: supportFiltersLoad.supportFiltersRuntime.summary
      }),
      hiddenRecordCount: supportVisibilityLoad.supportVisibilityRuntime.hiddenRecordCount,
      loadError: ticketsRuntimeLoad.ticketsRuntime.loadError ?? (supabase ? null : "Admin client unavailable"),
      metricsRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportVisibilityLoad.visibleSupportMetricsRuntime.readOnly,
        source: supportVisibilityLoad.visibleSupportMetricsRuntime.source,
        summary: supportVisibilityLoad.visibleSupportMetricsRuntime.summary
      }),
      monitoringEventsRuntime: toSupportProductionHardeningSnapshot({
        readOnly: monitoringEventsLoad.monitoringEventsRuntime.readOnly,
        source: monitoringEventsLoad.monitoringEventsRuntime.source,
        summary: monitoringEventsLoad.monitoringEventsRuntime.summary
      }),
      monitoringEventsSafeControls: monitoringEventsLoad.monitoringEventsSafeControls,
      notificationsRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportNotificationsLoad.supportNotificationsRuntime.readOnly,
        source: supportNotificationsLoad.supportNotificationsRuntime.source,
        summary: supportNotificationsLoad.supportNotificationsRuntime.summary
      }),
      ...
      productionCertificationItems: supportProductionCertificationLoad.productionCertificationItems,
      productionCertificationSafeControls: supportProductionCertificationLoad.productionCertificationSafeControls,
      registryRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportRegistry.registry.readOnly,
        source: supportRegistry.registry.source,
        summary: supportRegistry.registry.summary
      }),
      restrictedRecordCount: supportVisibilityLoad.supportVisibilityRuntime.restrictedRecordCount,
      reviewItems: supportReviewLoad.supportReviewRuntimeItems,
      reviewRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportReviewLoad.supportReviewRuntime.readOnly,
        source: supportReviewLoad.supportReviewRuntime.source,
        summary: supportReviewLoad.supportReviewRuntime.summary
      }),
      ...
      runtimeCertification: supportRuntimeCertificationLoad.runtimeCertification,
      runtimeCertificationSafeControls: supportRuntimeCertificationLoad.runtimeCertificationSafeControls,
      safeActionsRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportSafeActionsLoad.supportSafeActionsRuntime.readOnly,
        source: supportSafeActionsLoad.supportSafeActionsRuntime.source,
        summary: supportSafeActionsLoad.supportSafeActionsRuntime.summary
      }),
      searchRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportSearchLoad.supportSearchRuntime.readOnly,
        source: supportSearchLoad.supportSearchRuntime.source,
        summary: supportSearchLoad.supportSearchRuntime.summary
      }),
      ...
      securityCertificationItems: supportSecurityCertificationLoad.securityCertificationItems,
      securityCertificationSafeControls: supportSecurityCertificationLoad.securityCertificationSafeControls,
      statusRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportStatusLoad.supportStatusRuntime.readOnly,
        source: supportStatusLoad.supportStatusRuntime.source,
        summary: supportStatusLoad.supportStatusRuntime.summary
      }),
      ticketAssignmentRuntime: toSupportProductionHardeningSnapshot({
        readOnly: assignmentLoad.ticketAssignmentRuntime.readOnly,
        source: assignmentLoad.ticketAssignmentRuntime.source,
        summary: assignmentLoad.ticketAssignmentRuntime.summary
      }),
      ticketConversationRuntime: toSupportProductionHardeningSnapshot({
        readOnly: ticketConversationLoad.ticketConversationRuntime.readOnly,
        source: ticketConversationLoad.ticketConversationRuntime.source,
        summary: ticketConversationLoad.ticketConversationRuntime.summary
      }),
      ticketDetailsRuntime: toSupportProductionHardeningSnapshot({
        readOnly: ticketDetailsLoad.ticketDetailsRuntime.readOnly,
        source: ticketDetailsLoad.ticketDetailsRuntime.source,
        summary: ticketDetailsLoad.ticketDetailsRuntime.summary
      }),
      ticketStatusRuntime: toSupportProductionHardeningSnapshot({
        readOnly: ticketStatusLoad.ticketStatusRuntime.readOnly,
        source: ticketStatusLoad.ticketStatusRuntime.source,
        summary: ticketStatusLoad.ticketStatusRuntime.summary
      }),
      ticketsRuntime: toSupportProductionHardeningSnapshot({
        readOnly: ticketsRuntimeLoad.ticketsRuntime.readOnly,
        source: ticketsRuntimeLoad.ticketsRuntime.source,
        summary: ticketsRuntimeLoad.ticketsRuntime.summary
      }),
      ticketsSafeControls: ticketsRuntimeLoad.safeControls,
      visibilityAuthorization,
      visibilityRuntime: toSupportProductionHardeningSnapshot({
        readOnly: supportVisibilityLoad.supportVisibilityRuntime.readOnly,
        source: supportVisibilityLoad.supportVisibilityRuntime.source,
        summary: supportVisibilityLoad.supportVisibilityRuntime.summary
      }),
  ...
  if (!supabase) {
    ...
    return {
      ...
      supportAuditRuntime: supportAuditLoad.supportAuditRuntime,
      supportAuditRuntimeGroups: supportAuditLoad.supportAuditRuntimeGroups,
      ...
      supportDataCertification: supportDataCertificationLoad.dataCertification,
      supportDataCertificationGroups: supportDataCertificationLoad.dataCertificationGroups,
      supportDataCertificationItems: supportDataCertificationLoad.dataCertificationItems,
      supportDataCertificationSafeControls: supportDataCertificationLoad.dataCertificationSafeControls,
      visibleSupportDataCertification: supportDataCertificationLoad.dataCertification,
      supportSecurityCertification: supportSecurityCertificationLoad.securityCertification,
      supportSecurityCertificationGroups: supportSecurityCertificationLoad.securityCertificationGroups,
      ...
      supportProductionCertification: supportProductionCertificationLoad.productionCertification,
      supportProductionCertificationGroups: supportProductionCertificationLoad.productionCertificationGroups,
      ...
      supportProductionHardening: supportProductionHardeningLoad.productionHardening,
      supportProductionHardeningGroups: supportProductionHardeningLoad.productionHardeningGroups,
