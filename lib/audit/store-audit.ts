...
export type StoreAuditAction =
  ...
  | "admin.store_high_risk_cleared"
  | "admin.store_marked_under_review"
  | "admin.store_marked_reviewed"
  | "admin.store_marked_high_risk"
  | "admin.store_restored"
  | "admin.store_suspended"
  | "store_created"
