...
const SUPPORT_REGISTRY_DEFINITIONS: readonly SupportRegistryEntryDefinition[] = [
  ...
  },
  {
    ...
    createdFromArchitecture: true,
    description:
      "Support notifications runtime integrated with the certified Notifications Runtime. Read-only display only; no send, enqueue, or retry on page load.",
  ...
  },
  {
    ...
    createdFromArchitecture: true,
    description:
      "Support analytics runtime for ticket and event insights. Read-only derived counts from visible Support records only; no analytics pipeline execution on page load.",
    futureHooks: ["Export analytics", "Scheduled analytics refresh"],
    healthSupport: true,
  ...
  },
  {
    ...
    createdFromArchitecture: true,
    description:
      "Support export runtime for sanitized Support record downloads. Explicit Super Admin action only; no export execution on page load.",
    futureHooks: ["Scheduled export", "Export delivery audit review"],
    healthSupport: false,
    id: "support:export",
    implementationStatus: "production_ready",
    key: "sp-export",
  ...
  },
  {
    ...
    createdFromArchitecture: true,
    description:
      "Support status runtime consolidating operational readiness from visible Support module runtimes. Derived only; no status mutation on page load.",
    futureHooks: ["Blocked module review", "Global support health dashboard"],
    healthSupport: true,
    id: "support:status",
    implementationStatus: "production_ready",
    key: "sp-status",
  ...
  },
  {
    ...
    createdFromArchitecture: true,
    description:
      "Support security certification runtime validating Super Admin access, RLS safety, visibility boundaries, secret protection, and read-only page load across SP-1 through SP-22. Derived validation only; no security mutation on page load.",
    futureHooks: ["Runtime security certification", "Production security certification"],
    healthSupport: true,
    id: "support:security-certification",
    implementationStatus: "production_ready",
    key: "sp-security-certification",
    monitoringSupport: true,
    permissions: ["super_admin:read"],
    productionReady: true,
    roadmapPhase: "SP-23",
    runtimeType: "security_certification_runtime",
  ...
  },
  {
    ...
    createdFromArchitecture: true,
    description:
      "Support runtime certification runtime validating production-safe read-only Support runtime behavior across SP-1 through SP-23. Derived validation only; no runtime mutation on page load.",
    futureHooks: ["Production certification", "Runtime hardening"],
    healthSupport: true,
    id: "support:runtime-certification",
    implementationStatus: "production_ready",
    key: "sp-runtime-certification",
    monitoringSupport: true,
    permissions: ["super_admin:read"],
    productionReady: true,
    roadmapPhase: "SP-24",
