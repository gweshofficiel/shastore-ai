...
function statusMessage(value: string | undefined) {
  const messages: Record<string, string> = {
    ...
    "stripe-connect-failed": "Stripe Connect could not be started. Confirm STRIPE_SECRET_KEY is configured for the active Stripe test account.",
    "stripe-connect-missing-env": "Stripe Connect could not start because required env vars are missing.",
    "stripe-connect-platform-not-enabled": "Stripe Connect is not fully enabled for the active STRIPE_SECRET_KEY account. Open Stripe Dashboard → Connect and complete platform onboarding for that same account.",
    ...
    "stripe-oauth-callback-failed": "Stripe OAuth connection could not be completed. Check server logs for the Stripe response.",
    "stripe-oauth-denied": "Stripe OAuth authorization was cancelled or denied.",
    "stripe-oauth-invalid-state": "Stripe OAuth state could not be validated. Restart Connect Stripe from this dashboard.",
    "stripe-oauth-missing-code": "Stripe OAuth did not return an authorization code. Restart Connect Stripe.",
