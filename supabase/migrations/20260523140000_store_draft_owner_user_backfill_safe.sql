-- Backfill Store Mode owner linkage and align RLS with stores.user_id + stores.owner_user_id.
-- Safe additive migration: does not touch products, orders, checkout, or reseller systems.
